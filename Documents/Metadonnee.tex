...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.4]{img/NDVI_interpretation1.pdf}
...
L'Evaporative Fraction est un indice renseignant sur la capacité d'une
surface à évaporer, qu’elle soit composée de végétation ou non. D'après la figure \ref{EF1}, la moitié sud de l'image évapore peu, sauf quelques endroits correspondants aux espaces forestiers et au Parc Naturel de Brière. Ainsi, ne pas observer cette différence d'évaporation signifierai un stress hydrique important mettant en péril ces espaces.

\begin{figure}[!h]
\centering
\includegraphics[scale=0.4]{img/EF_interpretation1.pdf}
\caption{Evaporative Fraction au 18 Juin 2017 (à gauche) permettant de distinguer les espaces forestiers et le Parc Naturel de Brière et d'estimer le stress hydrique de la végétation.}
\label{EF1}
\end{figure}

\subsection{Température de jour}
...
\subsection{Température de nuit}
