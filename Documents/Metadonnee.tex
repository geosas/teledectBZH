...
La série temporelle accessible sur GéoBretagne présente l'avantage de couvrir différents aléas comme la canicule de 2003.

\begin{figure}[!h]
\centering
\includegraphics[scale=0.33]{img/plot_ts_ndvi.pdf}
